...
let aaa = function(node){
  console.log("aaa",node.key)
}
binaryTree.inorderTraversal(aaa)



let bbb = function(node){
  console.log("bbb",node.key)
}
binaryTree.inorderTraversal(bbb)
